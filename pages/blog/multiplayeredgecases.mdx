...
I am connected, but I can't see everyone in the lobby.

How to handle someone joining the game in the middle of a live session.

Dealing with a surge of 100+ users attempting to join a game with only an 8-person lobby.

What happens if someone is still in the lobby when the host starts the game?

Restarting the game while keeping everyone in the same room.

If a player drops out mid-game and it was their turn, how do we continue?

If the host drops out, who gains control?

What to do if a player receives a call and gets disconnected from the game – how can they reconnect?

Managing a queue of players waiting for an overfilled room, and how to allow others to join.

How can I remove a user who is abusing the system?
