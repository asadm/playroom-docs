...
<AuthorBio author="asad" date="Aug 14 2023" />
...
The code for plugin is open-source and available on [GitHub](https://github.com/asadm/playroom-unity/) if you want to check it out. Do check out the [documentation](/usage/docs) to see how easy it is to get started.