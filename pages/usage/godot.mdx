...
<Callout emoji="👷🏼‍♀️">
  Godot 4's web export is not production-grade yet. There are open bugs in [Chromium](https://bugs.chromium.org/p/chromium/issues/detail?id=1324296#c6) and in Godot itself[1](https://github.com/godotengine/godot/issues/83548) [2](https://github.com/godotengine/godot/issues/70691).
</Callout>
