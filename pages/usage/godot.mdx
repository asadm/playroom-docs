...
```
Or use the Community Playroom API Bundle (it has all of the same stuff, just it saves you some clutter) 
```html copy
<script type="module" src="https://acorn-studios.github.io/playroom/community-api
/playroom-bundle.js" crossorigin="anonymous"></script>
```
