...
#### Video Tutorial
<br />
<iframe style={{width: '100%', maxWidth: '80vw'}} height="400" src="https://www.youtube.com/embed/1LXWZmJxlKA?si=nKZOaoiEj_WwXt6X" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; muted" allowfullscreen autoPlay muted></iframe>
