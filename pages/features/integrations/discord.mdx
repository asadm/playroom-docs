...
<img src="/images/disc.png" style={{width: "100%", marginTop: '20px'}} alt="Discord Activity" />
...
Playroom Kit provides deep integration to manage this for you and lets you use Playroom Kit's state sync and other features for your games. You can also host your game on Playroom's Hosting; our ultra-fast CDN.

**Benefits of using Playroom Kit with Discord SDK:**
...
- 🎭 Player profile from Discord is available in Playroom Kit's shared state
- 🔗 API to show Discord invite dialog from your game
- ✨ You also get all of Playroom Kit's advanced features like persistence, RPCs, Bots and more
...
<img src="/images/disc-preview.png" style={{maxHeight: "500px", marginTop: '40px;'}} alt="Discord Activity Preview" />
...
## Running your Game
### Testing Locally
You can run your game locally and open it in browser to test. Playroom Kit will mock the Discord auth and user profile for you.
...
<img src="/images/discordinvite.jpg" style={{maxHeight: "500px", marginTop: '20px'}} alt="Discord Invite Dialog" />
