...
Players who have joined from their phones see an [on-screen joystick](/features/games/joystick#angular-with-buttons) to play the game.
...
See [Joystick API](/components/games/joystick) for more details.
