...
Playroom Kit includes a customizable on-screen joystick controller that can be used by players as input.
...
Here is a usage example, check out the **[API Docs](/api-reference/js/JoystickController)** for more details:
