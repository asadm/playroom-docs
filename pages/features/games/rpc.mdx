...
Playroom Kit supports RPCs (remote procedure calls) to allow players to call functions on other players' clients. RPCs are useful for implementing game actions such as shooting bullets, chat messages, taking damage, etc.
...
See the [API reference](/api-reference/js/RPC/register) for more details.