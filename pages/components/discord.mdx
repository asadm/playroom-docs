...
Check out the [Making a Multiplayer Game](/multiplayer) to learn how Playroom works or check out this [simple React example](https://github.com/asadm/playroom-docs/tree/main/examples/react-discord-simple).
</Callout>
