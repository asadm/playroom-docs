...
- ✅ Playroom complements Discord SDK by providing a multiplayer server and state sync
- ✅ Playroom handles Room and Player management for you
- ✅ Playroom handles user authentication for you, you get user's Discord profile directly without doing OAuth dance
...
- If you haven't already, create a game on [Playroom Dev Portal](https://dev.joinplayroom.com), click on **Discord** tab and follow the instructions to connect your Discord application.
