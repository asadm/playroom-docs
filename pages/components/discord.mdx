...
- ✅ Playroom is a multiplayer backend for your game, this is out of scope for Discord SDK
- ✅ Room and player profile management, Discord SDK doesn't create or manage rooms for you
- ✅ Includes authentication server, Discord SDK requires you to roll your own callback URL server to create auth-tokens
