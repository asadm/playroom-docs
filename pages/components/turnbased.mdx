...
- Player 1 creates a new game with `turnBased: true` and gets the challenge ID.
...
- Player 2 receives the challenge ID and uses it to join the game.
...
- Player 3 receives the challenge ID and uses it to join the game.
