...
Playroom Kit let's you easily make realtime multiplayer games. It provides sync and state management out of the box. 

It's built on top of [Playroom](https://joinplayroom.com) platform.
...
- First-class support for Phaser, React and Kaboom.js
