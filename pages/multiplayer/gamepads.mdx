...
Players who have joined from their phones see an [on-screen joystick](/multiplayer/joystick#angular-with-buttons) to play the game.
...
See [Joystick API](/multiplayer/joystick) for more details.
