...
<div className={styles.halfhalf}>
<div>
  Playroom also supports multi-device multiplayer games where one screen acts as the host and all players join from their mobile devices. This feature can be enabled using Stream mode as described [here](https://docs.joinplayroom.com/components/stream). Once Stream mode is enabled, you can have the main screen of the game streamed to a browser or TV with a QR code or room code, which serves as the central screen for gameplay.
