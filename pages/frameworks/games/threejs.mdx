...
Playroom Kit works great with Three.js for real-time collaborative 3D experiences. Below is a **live preview** of a simple flying plane game adapted from [this code by Codrops](https://github.com/yakudoo/TheAviator).
