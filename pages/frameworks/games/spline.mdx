...
You can see the full source code [here](https://github.com/asadm/playroom-docs/tree/main/public/demos/spline).
...
Then, we connect a joystick and send state to Playroom Kit:
