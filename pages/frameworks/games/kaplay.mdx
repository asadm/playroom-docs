...
To make a KAPLAY game multiplayer, you can pipe the game state to Playroom Kit state methods and also pipe the player inputs to Playroom Kit.
...
function start() {
  ...
  // 1. Pass Joystick data to Playroom Kit SDK
