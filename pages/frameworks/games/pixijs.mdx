...
Use the [Joystick](/features/games/joystick) to control ascii blobs in this simple, top-down demo!
...
The multiplayer parts are highlighted so you can see Playroom Kit in action! Find the full code [here](https://github.com/asadm/playroom-docs/blob/main/public/demos/pixijs1.html): 
