...
The code above activates bots in your game. It creates an instance of botClass using the botParams you provide. Here's how you'd use botParams your constructor:
