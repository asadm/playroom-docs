...
| Version   | Changes                                                                                                                              |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `v0.0.95` | - Fixed: Joystick buttons stay at true when pressed only otherwise false.|
| `v0.0.94` | - Added: Player state is now preserved when leaving and rejoining a room. |
| `v0.0.93` | - Added: `leaveRoom` method to leave the room voluntarily. e.g. `player.leaveRoom()` |
| `v0.0.92` | - <span style={{ color: 'red' }}>Breaking Change:</span> React19 supported added. Breaking change: React17 games are now deprecated.|
| `v0.0.91` | - Fixed the native mobile scrolling issues when joystick is enabled.|
| `v0.0.87` | - Fixed: `getAllTurns` returning `undefined` and corrected its name in documentation and types (was `getAllTurnsData`). |
